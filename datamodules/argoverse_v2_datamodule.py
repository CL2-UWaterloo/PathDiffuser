...
from transforms import TargetBuilderInit, TargetBuilderTraj
...
class ArgoverseV2DataModule(pl.LightningDataModule):
    ...
    def __init__(self,
                 ...
                 train_transform: Optional[Callable] = TargetBuilderInit(50, 60),
                 val_transform: Optional[Callable] = TargetBuilderInit(50, 60),

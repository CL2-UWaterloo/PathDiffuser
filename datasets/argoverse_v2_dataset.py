...
class ArgoverseV2Dataset(Dataset):
    ...
    Args:
        ...
        num_generation_timestep (int, Optional): the number of future time steps. (default: 60)
    ...
    def __init__(self,
                 ...
                 num_generation_timestep: int = 60,
        ...
        self.num_steps = init_timestep + num_generation_timestep
    ...
    def get_agent_features(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        for track_id, track_df in df.groupby('track_id'):
            ...
            current_valid_mask[agent_idx] = valid_mask[agent_idx, self.init_timestep]
            ...
            if self.vector_repr:  # a time step t is valid only when both t and t-1 are valid
                valid_mask[agent_idx, 1: self.init_timestep] = (
                        valid_mask[agent_idx, :self.init_timestep] &
                        valid_mask[agent_idx, 1: self.init_timestep])
